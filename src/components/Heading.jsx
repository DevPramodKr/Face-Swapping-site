...
const Heading = () => {
  ...
  return (
    <div className=' txt w-full h-[80vh] bg-[#050c0f]'>
        ...
        <p className='absolute left-11 top-[60%] w-80'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quia minus atque culpa laboriosam incidunt nesciunt quos vitae et explicabo expedita, saepe tenetur, odit facere cum iusto eveniet accusamus eius rerum.</p>
        </div>
    </div>
  )
}
